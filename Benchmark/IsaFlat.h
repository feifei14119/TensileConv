...
public:
	...
	{
		T_ExtFlatProblemConfig * extProblem = (T_ExtFlatProblemConfig *)ProblemConfig->extConfig;
		T_ExtFlatSolutionConfig * extSolution = (T_ExtFlatSolutionConfig *)SolutionConfig->extConfig;
