...
.set PREFETCH_LOOP,				(K/MLO_N_LCL_OUT_MAPS)
...
.endm
	...
	s_cbranch_scc1		CALCULATION													// if(gid >= 64) goto CALCULATION
...
PRE_FEATCH:
	...
	s_mov_b32				s[s_prefetch_loop_cnt], 0x0
...
PROD_WAIT:
	s_sleep					0x10
	s_load_dword 			s[s_tmp1], s[s_ptr_sig:s_ptr_sig+1], 0x0 
	s_waitcnt 				lgkmcnt(0)
	s_cmp_eq_u32			s[s_tmp1], 0x1234									// if(signal == 0x1234) prefetch next
	s_cbranch_scc0			PROD_WAIT
		
	s_add_u32 				s[s_prefetch_loop_cnt], s[s_prefetch_loop_cnt], 1
	s_cmpk_eq_i32 			s[s_loop_cnt], 0x0 + PREFETCH_LOOP
	s_cbranch_scc0 			PRE_FETCH_LOOP	
...
{ Version: [ 1, 0 ],
  Kernels: 
    - { Name: ConvFwd1x1_Jasm, SymbolName: 'ConvFwd1x1_Jasm', Language: OpenCL C, LanguageVersion: [ 1, 2 ],
        ...
        - { Name: d_sig , Size: 8, Align: 8, ValueKind: GlobalBuffer, ValueType: U32, TypeName: 'uint*', AddrSpaceQual: Global  }
      }
}
