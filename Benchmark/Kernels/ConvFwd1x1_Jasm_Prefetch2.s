...
// Disassembly:
	...
	v_and_b32			v[v_acc11], 0x0 + IN_PIXEL_PER_GROUP_MOD_MASK, v[tid]
	v_add_co_u32		v[v_acc13], vcc, v[v_acc13], v[v_acc11]
	...
	v_mul_u32_u24		v[v_acc9], v[v_acc7], v[v_acc9]
	v_mov_b32 			v[v_acc10], 0x0 + MLO_OUT_CHANNEL_STRIDE
	v_mul_u32_u24		v[v_acc11], v[v_acc6], v[v_acc10]
	v_add3_u32			v[v_acc12], v[v_acc9], v[v_acc11], v[v_acc8]
