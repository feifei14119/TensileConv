...
.text
.globl GlobalInstruction
.p2align 8
.type GlobalInstruction,@function
.amdgpu_hsa_kernel GlobalInstruction
...
{ Version: [ 1, 0 ],
  Kernels: 
    - { Name: GlobalInstruction, SymbolName: 'GlobalInstruction', Language: OpenCL C, LanguageVersion: [ 1, 2 ],
