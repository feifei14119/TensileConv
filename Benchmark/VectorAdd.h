...
public:
	...
	{
		T_ExtVectAddProblemConfig * exCfg = (T_ExtVectAddProblemConfig *)problemCfg->extConfig;
	...
	{
		T_ExtVectAddProblemConfig * extProblem = (T_ExtVectAddProblemConfig *)problemCfg->extConfig;
		T_ExtVectAddSolutionConfig * extSolution = (T_ExtVectAddSolutionConfig *)solutionCfg->extConfig;
		...
		{
			solutionCfg->KernelName = "VectorAdd";
