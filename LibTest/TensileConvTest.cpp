...
int main(int argc, char *argv[])
{
	...
	conv = new DirConv1x1Fwd();
	perfSec = conv->TuneProblem(60, 57, 1512, 28, 3, 1, 1, false, E_TCRelu::NORELU, E_TCSearch::AUTO, solution);
	printf("*************************************************************************\n");
	printf("*************************** TensileConv *********************************\n");
	printf("*************************************************************************\n");
	printf("kernel name: %s.\n", solution.kernel_name.c_str());
	...
	delete conv;
	conv = new DirConv1x1Fwd();
	perfSec = conv->TuneProblem(60, 57, 1512, 42, 3, 1, 1, false, E_TCRelu::NORELU, E_TCSearch::AUTO, solution);
	printf("*************************************************************************\n");
	printf("*************************** TensileConv *********************************\n");
	printf("*************************************************************************\n");
	printf("kernel name: %s.\n", solution.kernel_name.c_str());
